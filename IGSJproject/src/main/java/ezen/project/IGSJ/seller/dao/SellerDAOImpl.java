...
public class SellerDAOImpl implements SellerDAO {
	...
	public int searchOrder(String userId) throws Exception {
		return sqlSession.selectOne(Namespace + ".searchOrder", userId);
	}
	...
	public List<OrderVO> getOrderList(String userId, int displayTotalContent, int pageContent) throws Exception {
		...
		HashMap<String, Object> orderPageData = new HashMap<>();
		orderPageData.put("displayTotalContent", displayTotalContent);
		orderPageData.put("pageContent", pageContent);
		orderPageData.put("userId", userId);
